          ...
          {posts.length > 0 ? (
            ...
            <div className='min-h-[250px] flex flex-col items-center justify-center text-center p-8 rounded-2xl border border-dashed border-slate-800 bg-slate-900/10 space-y-3'>
              ...
              {!user && (
                <Link
                  href='/login'
                  className='mt-2 inline-flex bg-emerald-500/30 hover:bg-emerald-500 text-emerald-400 hover:text-slate-950 text-xs font-bold px-4 py-2 rounded-lg transition-all border border-emerald-500/20'>
